...
export const RECEIVE_DETAIL_RECOMAND_API_SUCCESS = 'RECEIVE_DETAIL_RECOMAND_API_SUCCESS';
export const RECEIVE_DETAIL_RECOMAND_API_FAILURE = 'RECEIVE_DETAIL_RECOMAND_API_FAILURE';
